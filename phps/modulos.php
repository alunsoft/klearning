...
if (!isset($_SESSION['id_usuario'])) {
  ...
  $q_modulos = "SELECT id_modulo, nombre,ejemplo,icono,color FROM modulo WHERE estado = 1";
  ...
  <div class="x_content">
    <div class="row">
      <?php while ($a_modulos = $e_modulos->fetch_array(MYSQLI_ASSOC)) { ?>
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12" onclick="fn_loadContent('x_panel_princiapl', 'phps/submodulos.php','id_modulo=<?php echo $a_modulos['id_modulo']; ?>')">
